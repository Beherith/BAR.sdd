...
for id, featureDef in pairs(FeatureDefs) do
	...
	if (not isTree) and featureDef.model.textures and featureDef.model.textures.tex1 and  featureDef.model.path and featureDef.model.path:find("%.3ds") == nil then --its likely a proper feature --104fix
